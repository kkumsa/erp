...
class ListUsers extends ListRecords implements HasInfolists
{
    ...
    public ?User $selectedRecord = null;

    public function selectRecord(int $recordId): void
    {
        if ($this->slideOverMode) {
            $this->selectedRecordId = $recordId;
            $this->selectedRecord = User::find($recordId);
            $this->dispatch('record-selected');
        } else {
            $this->redirect(UserResource::getUrl('edit', ['record' => $recordId]));
        }
    }
