...
class ListAttendances extends ListRecords implements HasInfolists
{
    ...
    public ?Attendance $selectedRecord = null;

    public function selectRecord(int $recordId): void
    {
        if ($this->slideOverMode) {
            $this->selectedRecordId = $recordId;
            $this->selectedRecord = Attendance::find($recordId);
            $this->dispatch('record-selected');
        } else {
            $this->redirect(AttendanceResource::getUrl('edit', ['record' => $recordId]));
        }
    }
    ...
    public function recordInfolist(Infolist $infolist): Infolist
    {
        ...
        return AttendanceResource::infolist($infolist)
