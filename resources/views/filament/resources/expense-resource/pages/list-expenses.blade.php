<x-filament-panels::page>
    ...
    >
        <x-slot name="title">
            {{ $selectedRecord?->title ?? '비용 상세' }}
        </x-slot>

        <x-slot name="headerActions">
            @if($selectedRecordId)
                <a
                    href="{{ \App\Filament\Resources\ExpenseResource::getUrl('view', ['record' => $selectedRecordId]) }}"
                ...
                <a
                    href="{{ \App\Filament\Resources\ExpenseResource::getUrl('edit', ['record' => $selectedRecordId]) }}"
